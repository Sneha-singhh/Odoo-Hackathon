...
//       }}
//     >
//       <div className="w-full max-w-md bg-[#2a1f4d] p-6 rounded-2xl shadow-lg text-white">
//         <h2 className="text-2xl font-bold text-center mb-6">Log in</h2>
//         <button
//         onClick={() => navigate('/')}
//         className="absolute top-6 right-6 text-purple-200 hover:text-white"
//         aria-label="Close"
//         >
//         <X size={28} />
//         </button>
...
//           <div>
//             <label htmlFor="email" className="text-sm text-purple-200 block mb-1">
//               Email
//             </label>
//             <input
//               id="email"
...
//           </div>
//           <div>
//             <label htmlFor="password" className="text-sm text-purple-200 block mb-1">
//               Password
//             </label>
//             <input
//               id="password"
